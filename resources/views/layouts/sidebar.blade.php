<div class="sidebar hidden sm:block w-0 sm:w-1/6 bg-gray-200 h-screen shadow fixed top-0 right-0 bottom-0 z-40 overflow-y-auto">
    <div class="mb-6 mt-20 px-6">
        ...
        {{-- <a href="{{ route('createcours') }}" class="flex items-center text-decoration-none text-gray-600 py-2 hover:text-blue-700">
            <i class="fas fa-book-reader"></i>
            <span class="ml-2 text-sm font-semibold m-2">ایجاد دوره</span>
        </a> --}}
        {{-- @role('Admin')

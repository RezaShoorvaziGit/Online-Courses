<div class="bg-blue-700 px-4 sm:px-6 py-3 flex items-center justify-between shadow h-16 fixed top-0 left-0 right-0 z-50">
    <div class="flex items-center text-white">
        <span class="font-semibold text-sm sm:text-xl tracking-tight">سامانه برگزاری آزمون انلاین</span>
        <span class="m-2" style="font-size: 2em; color:#E5E7E9;">
    ...
    {{-- <div class="relative">
            ...
            <div class="bg-blue-700 absolute top-0 right-0 mt-12 -mr-6 shadow rounded-bl rounded-br">
                <div class="hidden h-24 w-48" id="navdropdown">
                    <div class="px-8 py-4 border-t border-blue-800">
                        <a href="{{ route('login') }}" class="flex items-center pb-3 text-sm text-gray-200 font-semibold">
        ...
        @else 
            <div class="flex items-center">
                @if (Route::has('login'))
                    <div>
                        <a class="flex items-center mr-4 text-sm text-gray-200  text-decoration-none text-light " href="{{ route('login') }}" style=" color: inherit;">
                            <span class="m-2" style="font-size: 1.5em; color:#E5E7E9;">
                                <i class="fas fa-sign-in-alt"></i>
                              </span>
                            <span class="font-semibold text-sm sm:text-xl tr">ورود</span>
                        </a>
                    </div>
                @endif
            </div>
